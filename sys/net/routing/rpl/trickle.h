...
#define TRICKLE_INTERVAL_STACKSIZE (KERNEL_CONF_STACKSIZE_DEFAULT) /* Nhat: reduced stack size */
//#define DAO_DELAY_STACKSIZE (KERNEL_CONF_STACKSIZE_MAIN)
#define DAO_DELAY_STACKSIZE (KERNEL_CONF_STACKSIZE_DEFAULT) /* Nhat: reduced stack size */
